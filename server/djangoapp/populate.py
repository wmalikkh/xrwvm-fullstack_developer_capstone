def initiate():
    ...
    car_make_data = [
        {"name": "Toyota", "description": "Toyota Motor Corporation, a globally renowned automaker."},
        {"name": "Honda", "description": "Honda, known for reliability and innovation in automobiles."},
        {"name": "Ford", "description": "Ford Motor Company, an American multinational automaker."},
        {"name": "BMW", "description": "BMW, a German brand known for luxury and performance vehicles."},
        {"name": "Chevrolet", "description": "Chevrolet, an American automobile division of General Motors."},
    ]
    car_make_instances = []
    for data in car_make_data:
        cm = CarMake.objects.get_or_create(name=data["name"], defaults={"description": data["description"]})[0]
